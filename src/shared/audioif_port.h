...
// --- how a driver binds ---------------------------------------------------
//
// It defines `audioif_port_driver()`, which overrides the weak default below
...
typedef struct {
    ...
    // to be lifted to finish it. See shared/audioif_pump_lock.h for the
