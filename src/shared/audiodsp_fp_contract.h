...
#ifndef AUDIODSP_FP_CONTRACT_H
#define AUDIODSP_FP_CONTRACT_H
...
//
//     xtensa-esp32s3-elf-gcc -O2   audiodsp_feedback_delay.c   17 madd.s/msub.s
//     riscv32-esp-elf-gcc    -O2   audiodsp_feedback_delay.c   20 fmadd.s/...
//     xtensa-esp32s3-elf-gcc -O2   audiodsp_ladder.c           13
//     riscv32-esp-elf-gcc    -O2   audiodsp_ladder.c           15
//
// That was the whole of the P4-vs-S3 split on `audiodynamics`' transient attack
// path (audiodsp#66, 29 against 30 sites there), which this file generalises to
// the rest of the kernel (audiodsp#79). `docs/correctness-standard.md` holds our
...
//   * `-ffp-contract=off` as a build flag. On the CMake ports audiodsp's flags
...
// into a translation unit that never asked for it. No `audiodsp_*.h` includes
// this one.
//
...
// paragraph.
//
// The four `src/shared/` files that do not include this -- `audiodsp_sample.c`,
// `audiodsp_splitter.c`, `audiodsp_remix.c`, `audiodsp_synth_dsp.c` -- have no
