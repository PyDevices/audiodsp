...
static audiodsp_status_t rawsample_reset(void *context,
    bool single_channel_output, uint8_t audio_channel) {
    (void)single_channel_output;
    (void)audio_channel;
    audiodsp_rawsample_state_t *state = context;
...
static audiodsp_status_t rawsample_get(void *context,
    bool single_channel_output, uint8_t audio_channel,
    ...
    *result = AUDIODSP_BUFFER_DONE;
    return AUDIODSP_STATUS_OK;
}

static const audiodsp_sample_ops_t rawsample_ops = {
