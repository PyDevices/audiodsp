...
// turning this into a rate knob reports the bound; see audiodsp#97.
//
...
// audiodsp_shaper.c: each runtime reaches its audio graph differently.
//
...
#define AUDIODSP_SAMPLEHOLD_FRAMES 256u
...
#define AUDIODSP_SAMPLEHOLD_MAX_FRAME_BYTES 4u
...
#define AUDIODSP_SAMPLEHOLD_MAX_RATIO 1073741824u
...
typedef struct {
    ...
    uint32_t phase;
    uint8_t held[AUDIODSP_SAMPLEHOLD_MAX_FRAME_BYTES];
} audiodsp_samplehold_state_t;
...
//: be 1..AUDIODSP_SAMPLEHOLD_MAX_FRAME_BYTES; the bindings check it once, at
